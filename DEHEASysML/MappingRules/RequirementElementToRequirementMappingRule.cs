...
/// that takes a <see cref="List{T}" /> of <see cref="EnterpriseArchitectRequirementsSpecificationElement" /> as input and
...
public class RequirementElementToRequirementMappingRule :
    DstToHubBaseMappingRule<List<EnterpriseArchitectRequirementsSpecificationElement>, List<MappedRequirementsSpecificationRowViewModel>>
{
    /// <summary>
    ...
    /// <summary>
    /// Colletion of <see cref="EnterpriseArchitectRequirementsSpecificationElement" />
    /// </summary>
    private List<EnterpriseArchitectRequirementsSpecificationElement> mappedElements;

    /// <summary>
    /// The <see cref="Category" /> to apply to each <see cref="Requirement" />, <see cref="RequirementsGroup" /> and
    /// <see cref="RequirementsSpecification" />
    /// </summary>
    private Category requirementCategory;

    /// <summary>
    /// Transform a <see cref="List{T}" /> of <see cref="EnterpriseArchitectRequirementsSpecificationElement" /> into a
    /// <see cref="List{T}" /> of
    /// <see cref="MappedRequirementsSpecificationRowViewModel" />
    /// </summary>
    /// <param name="input">
    /// The <see cref="List{T}" /> of <see cref="EnterpriseArchitectRequirementsSpecificationElement " />
    /// </param>
    /// <returns>A collection of <see cref="MappedRequirementsSpecificationRowViewModel" /></returns>
    public override List<MappedRequirementsSpecificationRowViewModel> Transform(List<EnterpriseArchitectRequirementsSpecificationElement> input)
    {
        try
        {
            ...
            this.requirementsSpecifications.AddRange(this.HubController.OpenIteration.RequirementsSpecification);
            this.mappedElements = new List<EnterpriseArchitectRequirementsSpecificationElement>(input);
            ...
            return new List<MappedRequirementsSpecificationRowViewModel>(this.mappedElements);
        }
    ...
    /// <summary>
    /// Creates all <see cref="BinaryRelationship" /> between the mapped <see cref="Requirement" />s
    /// </summary>
    ...
    /// <see cref="EnterpriseArchitectRequirementsSpecificationElement" />
    /// </summary>
    /// <param name="mappedElement">The <see cref="EnterpriseArchitectRequirementsSpecificationElement" /></param>
    private void CreateRelationShips(EnterpriseArchitectRequirementsSpecificationElement mappedElement)
    {
    ...
    /// <summary>
    /// Maps the provided <see cref="EnterpriseArchitectRequirementsSpecificationElement" />
    /// </summary>
    /// <param name="mappedElement">The <see cref="EnterpriseArchitectRequirementsSpecificationElement" /> to map</param>
    private void MapRequirement(EnterpriseArchitectRequirementsSpecificationElement mappedElement)
    {
        ...
        {
            if (!this.TryGetOrCreateRequirementsSpecification(mappedElement.DstElement, out requirementsSpecification))
            {
        ...
        mappedElement.HubElement = requirementsSpecification;
    }
    ...
    /// <summary>
    /// Tries to get a existing <see cref="RequirementsGroup" /> or created one based on the <see cref="Element" />
    /// It also creates the <see cref="Requirement" /> corresponding to the <see cref="Element" />
    /// </summary>
    /// <param name="requirementElement">The <see cref="Element" /></param>
    /// <param name="requirementsSpecification">The <see cref="RequirementsSpecification" /></param>
    /// <returns>A value indicating whether the <see cref="RequirementsSpecification" /> has been created or retrieved</returns>
    private bool TryGetOrCreateRequirementsSpecification(Element requirementElement, out RequirementsSpecification requirementsSpecification)
    {
        if (!this.TryGetOrCreateRequirementsSpecification(requirementElement.Name, out requirementsSpecification)
            || !this.TryGetOrCreateRequirement(requirementElement, out var requirement))
        {
            return false;
        }
    ...
    /// <summary>
    /// Creates a new <see cref="CDP4Common.CommonData.Definition" />
    /// </summary>
    /// <returns>A <see cref="CDP4Common.CommonData.Definition" /></returns>
